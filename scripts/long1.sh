...
#PBS -o /user/gent/453/vsc45342/thesis/logs/long.o$PBS_JOBID
#PBS -e /user/gent/453/vsc45342/thesis/logs/long.e$PBS_JOBID
#PBS -m abe
...
~/.conda/envs/sbsim/bin/python scripts/train_rl.py --mode long_eval1 --algo sac --seed 42 --unique_run
