...
# ml  PyTorch/2.7.1-foss-2024a-CUDA-12.6.0
...
~/.conda/envs/sbsim/bin/python scripts/train_rl.py --mode mini --algo sac --seed 42 --unique_run --floorplan office_4room --weather_csv /user/gent/453/vsc45342/thesis/weather_data/belgium_weather_multiyear.csv
