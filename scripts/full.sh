...
~/.conda/envs/sbsim/bin/python scripts/train_rl.py --mode full --algo sac --seed 42 --unique_run --weather_csv /user/gent/453/vsc45342/thesis/weather_data/oslo_weather_multiyear.csv
